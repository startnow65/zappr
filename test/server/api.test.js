...
describe('API', () => {
  ...
  before(async(done) => {
    ...
    try {
      ...
      fixtures.pullRequestFiles = require('../fixtures/github.pull_request.files.json')
      ...
      await mb.imposter()
              ...
              .stub()
                .response()
                  .setStatusCode(200)
                  .setHeader('Content-Type', 'application/json')
                  .setBody(fixtures.pullRequestFiles)
                .add()
                .predicate()
                  .setPath(`/repos/${fixtures.repoOwner}/${fixtures.repoName}/pulls/${fixtures.pullRequests[0].number}/files`)
                  .setMethod('GET')
                .add()
              .add()
              .stub()
                ...
                .add()
                .predicate()
                  .setPath(`/repos/${fixtures.repo2FullName}/pulls/${fixtures.pullRequests[0].number}/files`)
                  .setMethod('GET')
                .add()
              .add()
              .create()
